...
public class DatabaseManager : MonoBehaviour
{
    ...
    private static Queue<List<SensorData>> inputQ = new Queue<List<SensorData>>();
    private static Queue<UInt64> inputQTime = new Queue<UInt64>();
    ...
    public static Queue<UInt64> InputQTime
    {
        get
        {
            return inputQTime;
